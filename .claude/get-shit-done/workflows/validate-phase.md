...
```
Task(
  prompt="Read /Users/alec/Projects/unsere-news/.claude/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/alec/Projects/unsere-news/.claude/get-shit-done/templates/VALIDATION.md`
