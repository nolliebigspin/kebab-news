...
<required_reading>
@/Users/alec/Projects/unsere-news/.claude/get-shit-done/references/ai-frameworks.md
@/Users/alec/Projects/unsere-news/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read /Users/alec/Projects/unsere-news/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "/Users/alec/Projects/unsere-news/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read /Users/alec/Projects/unsere-news/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read /Users/alec/Projects/unsere-news/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read /Users/alec/Projects/unsere-news/.claude/agents/gsd-eval-planner.md for instructions.
