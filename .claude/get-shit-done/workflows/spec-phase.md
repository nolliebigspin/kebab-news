...
```bash
INIT=$(node "/Users/alec/Projects/unsere-news/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/alec/Projects/unsere-news/.claude/get-shit-done/templates/spec.md.
