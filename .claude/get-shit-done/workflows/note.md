...
- **Global scope**: `/Users/alec/Projects/unsere-news/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/alec/Projects/unsere-news/.claude/notes/`)
...
2. Glob `/Users/alec/Projects/unsere-news/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/alec/Projects/unsere-news/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/alec/Projects/unsere-news/.claude/notes/` — works in any directory
