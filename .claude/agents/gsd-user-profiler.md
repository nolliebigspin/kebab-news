...
<reference>
@/Users/alec/Projects/unsere-news/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/alec/Projects/unsere-news/.claude/get-shit-done/references/user-profiling.md` to load:
